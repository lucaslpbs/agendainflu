        ...
        <div className="card-gradient-border p-8 space-y-6">
          ...
          <div className="space-y-2">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white/60 hover:text-white hover:border-white/20 hover:bg-white/8 transition-all disabled:opacity-50"
            >
              ...
              Entrar com Google como <span className="text-[#00D4FF] font-medium">Cliente</span>
            </button>

            <button
              type="button"
              onClick={() => handleGoogleLogin('influencer')}
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white/60 hover:text-white hover:border-white/20 hover:bg-white/8 transition-all disabled:opacity-50"
            >
              <svg width="18" height="18" viewBox="0 0 24 24">
              ...
              Entrar com Google como <span className="text-[#FF2D87] font-medium">Influenciadora</span>
            </button>
          </div>
